...
type BouncerConfig struct {
	...
	// this cache unboundedly. Defaults to 1000 when unset/<=0 - see
	// spoa.defaultChallengeCacheMaxEntries - which is generous for legitimate
	// traffic while still bounding worst-case memory. Once at capacity, the
